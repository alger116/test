        ...
        syntaxErrorToString = function () {
          ...
          if (typeof process !== 'undefined' && process !== null) {
            colorsEnabled =
              ...
              !((ref3 = process.env) != null ? ref3.NODE_DISABLE_COLORS : void 0);
          }
          if ((ref4 = this.colorful) != null ? ref4 : colorsEnabled) {
            ...
            codeLine =
              codeLine.slice(0, start) + colorize(codeLine.slice(start, end)) + codeLine.slice(end);
            ...
            while (
              ...
              (backStack.length ||
                (((ref2 = this.tag(i)), indexOf.call(tags, ref2) < 0) &&
                  (((ref3 = this.tag(i)), indexOf.call(EXPRESSION_START, ref3) < 0) ||
              ...
              if (
                ((ref1 = this.tag(i)), indexOf.call(EXPRESSION_START, ref1) >= 0) &&
                backStack.length
              ) {
                backStack.pop();
              }
          ...
          Rewriter.prototype.addImplicitBracesAndParens = function () {
            ...
            return this.scanTokens(function (token, i, tokens) {
              ...
              if (tag === ':') {
                ...
                startsLine =
                  s === 0 ||
                  ((ref2 = this.tag(s - 1)), indexOf.call(LINEBREAKS, ref2) >= 0) ||
                  tokens[s - 1].newLine;
                if (stackTop()) {
                  (ref3 = stackTop()), (stackTag = ref3[0]), (stackIdx = ref3[1]);
                  if (
                    (stackTag === '{' ||
                      (stackTag === 'INDENT' && this.tag(stackIdx - 1) === '{')) &&
              ...
              if (
                ...
                while (inImplicit()) {
                  (ref4 = stackTop()),
                    (stackTag = ref4[0]),
                    (stackIdx = ref4[1]),
                    ((ref5 = ref4[2]), (sameLine = ref5.sameLine), (startsLine = ref5.startsLine));
            ...
            condition = function (token, i) {
              ...
              return (
                (token[1] !== ';' &&
                  ...
                  !(
                    token[0] === 'TERMINATOR' &&
                    ((ref1 = this.tag(i + 1)), indexOf.call(EXPRESSION_CLOSE, ref1) >= 0)
                  ) &&
    ...
    require['./lexer'] = (function () {
      ...
      (function () {
        ...
        exports.Lexer = Lexer = (function () {
          ...
          Lexer.prototype.numberToken = function () {
            ...
            switch (false) {
              ...
              case !/^(?!0x).*E/.test(number):
                this.error(
                  "exponential notation in '" + number + "' must be indicated with a lowercase 'e'",
                  {
          ...
          Lexer.prototype.jsToken = function () {
            ...
            if (
              !(
                this.chunk.charAt(0) === '`' &&
                (match = HERE_JSTOKEN.exec(this.chunk) || JSTOKEN.exec(this.chunk))
              )
            ) {
              return 0;
            }
          ...
          Lexer.prototype.outdentToken = function (moveOut, noNewlines, outdentLength) {
            ...
            while (moveOut > 0) {
              ...
              if (!lastIndent) {
                ...
                if (
                  outdentLength &&
                  ((ref2 = this.chunk[outdentLength]), indexOf.call(INDENTABLE_CLOSERS, ref2) >= 0)
                ) {
          ...
          Lexer.prototype.whitespaceToken = function () {
            ...
            if (
              !((match = WHITESPACE.exec(this.chunk)) || (nline = this.chunk.charAt(0) === '\n'))
            ) {
              return 0;
            }
            (ref2 = this.tokens), (prev = ref2[ref2.length - 1]);
          ...
          Lexer.prototype.makeToken = function (tag, value, offsetInChunk, length) {
            ...
            (ref3 = this.getLineAndColumnFromChunk(offsetInChunk + lastCharacter)),
          ...
          Lexer.prototype.validateEscapes = function (str, options) {
            ...
            return this.error(message + ' ' + invalidEscape, {
              offset:
                ((ref2 = options.offsetInChunk) != null ? ref2 : 0) + match.index + before.length,
          ...
          Lexer.prototype.makeDelimitedLiteral = function (body, options) {
            ...
            body = body.replace(
              regex,
              function (match, backslash, nul, delimiter, lf, cr, ls, ps, other) {
                switch (false) {
                  case !backslash:
                    if (options.double) {
        ...
        isUnassignable = function (name, displayName) {
          ...
          switch (false) {
            case indexOf.call(slice.call(JS_KEYWORDS).concat(slice.call(COFFEE_KEYWORDS)), name) <
              0:
...
*/
      var parser = (function () {
        var o = function (k, v, o, l) {
          ...
          $VX = [1, 104],
          $VY = [
            1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140, 156,
            159, 160, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174,
          ],
          $VZ = [2, 165],
          $V_ = [1, 110],
          $V$ = [1, 111],
          ...
          $V81 = [1, 121],
          $V91 = [
            1, 6, 31, 32, 40, 41, 42, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 113, 114, 115,
            120, 122, 131, 133, 134, 135, 139, 140, 156, 159, 160, 163, 164, 165, 166, 167, 168,
            169, 170, 171, 172, 173, 174,
          ],
          $Va1 = [2, 94],
          $Vb1 = [
            1, 6, 31, 32, 42, 46, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 113, 114, 115, 120,
            122, 131, 133, 134, 135, 139, 140, 156, 159, 160, 163, 164, 165, 166, 167, 168, 169,
            170, 171, 172, 173, 174,
          ],
          $Vc1 = [2, 73],
          $Vd1 = [1, 128],
          ...
          $Vg1 = [1, 136],
          $Vh1 = [
            1, 6, 31, 32, 40, 41, 42, 55, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 113, 114, 115,
            120, 122, 131, 133, 134, 135, 139, 140, 156, 159, 160, 163, 164, 165, 166, 167, 168,
            169, 170, 171, 172, 173, 174,
          ],
          $Vi1 = [2, 91],
          $Vj1 = [
            1, 6, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140, 156, 159,
            160, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174,
          ],
          $Vk1 = [2, 63],
          $Vl1 = [1, 166],
          $Vm1 = [1, 178],
          ...
          $Vq1 = [1, 184],
          $Vr1 = [
            1, 6, 31, 32, 40, 41, 42, 55, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 96, 113, 114,
            115, 120, 122, 131, 133, 134, 135, 139, 140, 156, 159, 160, 161, 162, 163, 164, 165,
            166, 167, 168, 169, 170, 171, 172, 173, 174, 175,
          ],
          $Vs1 = [2, 110],
          $Vt1 = [
            1, 6, 31, 32, 40, 41, 42, 58, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 113, 114, 115,
            120, 122, 131, 133, 134, 135, 139, 140, 156, 159, 160, 163, 164, 165, 166, 167, 168,
            169, 170, 171, 172, 173, 174,
          ],
          $Vu1 = [
            1, 6, 31, 32, 40, 41, 42, 46, 58, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 113, 114,
            115, 120, 122, 131, 133, 134, 135, 139, 140, 156, 159, 160, 163, 164, 165, 166, 167,
          ...
          $VD1 = [
            1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140, 156,
            159, 160, 164, 166, 167, 168, 169, 170, 171, 172, 173, 174,
          ],
          ...
          $VM1 = [
            1, 6, 31, 32, 40, 41, 42, 55, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 113, 114, 115,
            120, 122, 131, 133, 134, 135, 139, 140, 146, 147, 148, 156, 159, 160, 163, 164, 165,
            166, 167, 168, 169, 170, 171, 172, 173, 174,
          ],
          $VN1 = [1, 297],
          $VO1 = [6, 31, 32, 70, 115, 120],
          $VP1 = [
            1, 6, 31, 32, 40, 41, 42, 55, 58, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 96, 113,
            114, 115, 120, 122, 131, 133, 134, 135, 139, 140, 146, 147, 148, 156, 159, 160, 161,
          ...
          $VZ1 = [
            1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140, 156,
            159, 160, 166, 167, 168, 169, 170, 171, 172, 173, 174,
          ],
          $V_1 = [
            12, 28, 34, 38, 40, 41, 44, 45, 48, 49, 50, 51, 52, 53, 61, 62, 63, 67, 68, 89, 92, 95,
            97, 105, 112, 117, 118, 119, 125, 129, 130, 133, 135, 137, 139, 149, 155, 157, 158, 159,
            160, 161, 162,
          ],
          $V$1 = [2, 175],
          $V02 = [6, 31, 32],
          ...
          $V32 = [1, 324],
          $V42 = [
            1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 127, 128, 131, 133, 134, 135, 139,
            140, 151, 153, 156, 159, 160, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173,
            174,
          ],
          $V52 = [32, 151, 153],
          ...
          $Vc2 = [1, 367],
          $Vd2 = [
            1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140, 151,
            156, 159, 160, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174,
          ],
          $Ve2 = [
            1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 135, 139, 140, 156,
          ],
          $Vf2 = [1, 380],
          $Vg2 = [1, 381],
          $Vh2 = [6, 31, 32, 94],
          $Vi2 = [6, 31, 32, 70],
          $Vj2 = [
            1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 127, 131, 133, 134, 135, 139, 140,
            156, 159, 160, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174,
          ],
          $Vk2 = [31, 70],
          $Vl2 = [1, 407],
        ...
        var parser = {
            ...
            switch (yystate) {
              ...
              case 127:
                this.$ = yy.addLocationDataFn(
                  ...
                  new yy.ImportDeclaration(
                    new yy.ImportClause(null, new yy.ImportSpecifierList($$[$0 - 4])),
                    $$[$0]
                  )
                );
                break;
              ...
              case 129:
                this.$ = yy.addLocationDataFn(
                  ...
                  new yy.ImportDeclaration(
                    new yy.ImportClause($$[$0 - 7], new yy.ImportSpecifierList($$[$0 - 4])),
                    $$[$0]
                  )
                );
                break;
              ...
              case 209:
                this.$ = yy.addLocationDataFn(
                  ...
                  new yy.While(
                    yy.addLocationDataFn(_$[$0 - 1])(new yy.BooleanLiteral('true'))
                  ).addBody($$[$0])
                );
                break;
              case 210:
                this.$ = yy.addLocationDataFn(
                  ...
                  new yy.While(
                    yy.addLocationDataFn(_$[$0 - 1])(new yy.BooleanLiteral('true'))
                  ).addBody(yy.addLocationDataFn(_$[$0])(yy.Block.wrap([$$[$0]])))
                );
                break;
              case 211:
              case 212:
          ...
          table: [
            ...
            o($VH, [2, 7], { 141: 77, 132: 105, 138: 106, 133: $Vu, 135: $Vv, 139: $Vx, 156: $VX }),
            o($VH, [2, 8]),
            o($VY, [2, 14], {
              109: 107,
              78: 108,
            ...
            o(
              [
                1, 6, 32, 42, 131, 133, 135, 139, 156, 163, 164, 165, 166, 167, 168, 169, 170, 171,
                172, 173, 174,
              ],
              $V61,
              {
            ...
            o($Vh1, $Vi1, { 96: [1, 149], 161: [1, 146], 162: [1, 147], 175: [1, 148] }),
            ...
            { 25: 168, 33: 169, 34: $V2, 92: [1, 167], 95: $Vk, 103: [1, 170], 107: [1, 171] },
            o($Vh1, [2, 92]),
            o($Vh1, [2, 93]),
            o($V91, [2, 40]),
            o($V91, [2, 41]),
            ...
            o(
              [
                1, 6, 31, 32, 42, 46, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 113, 115, 120,
                122, 131, 133, 134, 135, 139, 140, 156, 159, 160, 163, 164, 165, 166, 167, 168, 169,
                170, 171, 172, 173, 174,
              ],
              [2, 163],
            ...
            o(
              [
                1, 6, 29, 31, 32, 40, 41, 42, 55, 58, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94,
                96, 102, 113, 114, 115, 120, 122, 131, 133, 134, 135, 139, 140, 146, 147, 148, 156,
            ...
            { 132: 105, 133: $Vu, 135: $Vv, 138: 106, 139: $Vx, 141: 77, 156: $VX },
            o(
              [
                1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140,
                156, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174,
              ],
              $V61,
              {
                15: 7,
            ...
            o(
              [
                1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140,
                156, 159, 160, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174,
              ],
              [2, 248],
              { 141: 77, 132: 102, 138: 103, 163: $VL }
            ),
            o($VD1, [2, 249], { 141: 77, 132: 102, 138: 103, 163: $VL, 165: $VN }),
            o($VD1, [2, 250], { 141: 77, 132: 102, 138: 103, 163: $VL, 165: $VN }),
            o($VD1, [2, 251], { 141: 77, 132: 102, 138: 103, 163: $VL, 165: $VN }),
            o($VY, [2, 252], {
              40: $Vi1,
              41: $Vi1,
              82: $Vi1,
            ...
            { 29: [1, 273], 70: [1, 274] },
            { 29: [1, 275] },
            { 31: $VH1, 33: 280, 34: $V2, 94: [1, 276], 100: 277, 101: 278, 103: $VI1 },
            o([29, 70], [2, 139]),
            { 102: [1, 282] },
            { 31: $VJ1, 33: 287, 34: $V2, 94: [1, 283], 103: $VK1, 106: 284, 108: 285 },
            o($V51, [2, 143]),
            { 55: [1, 289] },
            {
              7: 290,
            ...
            o(
              [
                1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 156,
                159, 160, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174,
              ],
              [2, 214],
              { 140: [1, 304] }
            ...
            { 6: $VG, 42: [1, 315] },
            o($VH, [2, 4]),
            o($VZ1, [2, 257], { 141: 77, 132: 102, 138: 103, 163: $VL, 164: $VM, 165: $VN }),
            o($VZ1, [2, 258], { 141: 77, 132: 102, 138: 103, 163: $VL, 164: $VM, 165: $VN }),
            o($VD1, [2, 259], { 141: 77, 132: 102, 138: 103, 163: $VL, 165: $VN }),
            o($VD1, [2, 260], { 141: 77, 132: 102, 138: 103, 163: $VL, 165: $VN }),
            o(
              [
                1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140,
              ...
              [2, 261],
              { 141: 77, 132: 102, 138: 103, 159: $VJ, 160: $VK, 163: $VL, 164: $VM, 165: $VN }
            ),
            o(
              [
                1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140,
                156, 167, 168, 169, 170, 171, 172, 173,
              ],
              [2, 262],
              {
                141: 77,
            ...
            o(
              [
                1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140,
                156, 167, 168, 169, 170, 171, 172, 173, 174,
              ],
              [2, 269],
              {
                141: 77,
            ...
            o(
              [
                12, 28, 34, 38, 40, 41, 44, 45, 48, 49, 50, 51, 52, 53, 61, 62, 63, 67, 68, 92, 95,
                97, 105, 112, 117, 118, 119, 125, 129, 130, 133, 135, 137, 139, 149, 155, 157, 158,
                159, 160, 161, 162,
              ],
              $V$1,
            ...
            o(
              [1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 135, 139, 156],
              [2, 225],
              {
                141: 77,
                132: 102,
      ...
      (function () {
        ...
        exports.Scope = Scope = (function () {
          function Scope(parent, expressions, method, referencedVars) {
            ...
            this.root =
              (ref = (ref1 = this.parent) != null ? ref1.root : void 0) != null ? ref : this;
          }
      ...
      (function () {
        ...
        exports.CodeFragment = CodeFragment = (function () {
          ...
          CodeFragment.prototype.toString = function () {
            return (
              '' +
              this.code +
              (this.locationData ? ': ' + locationDataToString(this.locationData) : '')
            );
          };
            ...
            if (scope.expressions === this) {
              ...
              if (declars || assigns) {
                ...
                if (assigns) {
                  ...
                  fragments.push(
                    this.makeCode(scope.assignedVariables().join(',\n' + (this.tab + TAB)))
                  );
                }
                fragments.push(this.makeCode(';\n' + (this.spaced ? '\n' : '')));
        ...
        exports.Value = Value = (function (superClass1) {
          ...
          Value.prototype.looksStatic = function (className) {
            ...
            return (
              ...
              ((ref3 = this.properties[0].name) != null ? ref3.value : void 0) !== 'prototype'
            );
          };
        ...
        exports.SuperCall = SuperCall = (function (superClass1) {
          ...
          function SuperCall(args) {
            SuperCall.__super__.constructor.call(
              this,
              null,
              args != null ? args : [new Splat(new IdentifierLiteral('arguments'))]
            );
        ...
        exports.Range = Range = (function (superClass1) {
          ...
          Range.prototype.compileVariables = function (o) {
            ...
            (ref3 = this.cacheToCodeFragments(this.from.cache(o, LEVEL_LIST, isComplex))),
              (this.fromC = ref3[0]),
              (this.fromVar = ref3[1]);
            (ref4 = this.cacheToCodeFragments(this.to.cache(o, LEVEL_LIST, isComplex))),
              (this.toC = ref4[0]),
              (this.toVar = ref4[1]);
            if ((step = del(o, 'step'))) {
              (ref5 = this.cacheToCodeFragments(step.cache(o, LEVEL_LIST, isComplex))),
                (this.step = ref5[0]),
                (this.stepVar = ref5[1]);
            }
            ...
            condPart =
              this.stepNum != null
                ? this.stepNum > 0
                  ...
                  : gt + ' ' + this.toVar
                : known
                  ? (((ref4 = [this.fromNum, this.toNum]), (from = ref4[0]), (to = ref4[1]), ref4),
                    from <= to ? lt + ' ' + to : gt + ' ' + to)
                  : ((cond = this.stepVar
                      ? this.stepVar + ' > 0'
          ...
          Class.prototype.ensureConstructor = function (name) {
            if (!this.ctor) {
              ...
              if (this.externalCtor) {
                ...
                this.ctor.body.push(
                  new Literal(name + '.__super__.constructor.apply(this, arguments)')
                );
              }
        ...
        exports.ImportSpecifier = ImportSpecifier = (function (superClass1) {
          ...
          ImportSpecifier.prototype.compileNode = function (o) {
            var ref3;
            if (
              ((ref3 = this.identifier), indexOf.call(o.importedSymbols, ref3) >= 0) ||
        ...
        exports.Assign = Assign = (function (superClass1) {
          ...
          Assign.prototype.checkAssignability = function (o, varBase) {
            if (
              Object.prototype.hasOwnProperty.call(o.scope.positions, varBase.value) &&
          ...
          Assign.prototype.compileNode = function (o) {
            ...
            if (this.value instanceof Code) {
              if (this.value['static']) {
                ...
                (ref6 = this.variable.properties),
                  (properties =
                    3 <= ref6.length ? slice.call(ref6, 0, (j = ref6.length - 2)) : ((j = 0), [])),
                  (prototype = ref6[j++]),
                  (name = ref6[j++]);
            ...
            if (!this.context) {
              ...
              if (
                !(typeof varBase.hasProperties === 'function' ? varBase.hasProperties() : void 0)
              ) {
          ...
          Assign.prototype.compilePatternMatch = function (o) {
            ...
            if (!(value.unwrap() instanceof IdentifierLiteral) || this.variable.assigns(vvarText)) {
              assigns.push(
                [this.makeCode((ref = o.scope.freeVariable('ref')) + ' = ')].concat(
                  slice.call(vvar)
                )
              );
          ...
          Assign.prototype.compileSplice = function (o) {
            ...
            answer = [].concat(
              this.makeCode('[].splice.apply(' + name + ', [' + fromDecl + ', ' + to + '].concat('),
              valDef,
              this.makeCode(')), '),
              valRef
            );
        ...
        exports.Op = Op = (function (superClass1) {
          ...
          Op.prototype.invert = function () {
            ...
            if (this.isChainable() && this.first.isChainable()) {
              ...
              ((ref3 = fst.operator) === '!' || ref3 === 'in' || ref3 === 'instanceof')
            ) {
              return fst;
            } else {
              return new Op('!', this);
          ...
          Op.prototype.unfoldSoak = function (o) {
            var ref3;
            return (
              ((ref3 = this.operator) === '++' || ref3 === '--' || ref3 === 'delete') &&
        ...
        exports.Try = Try = (function (superClass1) {
          ...
          Try.prototype.jumps = function (o) {
            var ref3;
            return (
              this.attempt.jumps(o) || ((ref3 = this.recovery) != null ? ref3.jumps(o) : void 0)
            );
          };
        ...
        exports.Parens = Parens = (function (superClass1) {
          ...
          Parens.prototype.compileNode = function (o) {
            ...
            bare =
              o.level < LEVEL_OP &&
              (expr instanceof Op || expr instanceof Call || (expr instanceof For && expr.returns));
            if (bare) {
              return fragments;
            } else {
              return this.wrapInBraces(fragments);
          ...
          For.prototype.compileNode = function (o) {
            ...
            if (this.pattern) {
              body.expressions.unshift(
                new Assign(
                  this.name,
                  this.from ? new IdentifierLiteral(kvar) : new Literal(svar + '[' + kvar + ']')
                )
              );
            }
              ...
              if (
                !(
                  ...
                  (val instanceof Value &&
                    ((ref5 = val.base) != null ? ref5.unwrapAll() : void 0) instanceof Code &&
                    val.properties.length === 1 &&
                    ((ref6 = (ref7 = val.properties[0].name) != null ? ref7.value : void 0) ===
                      'call' ||
                      ref6 === 'apply'))
                )
              ) {
        ...
        exports.If = If = (function (superClass1) {
          ...
          If.prototype.isStatement = function (o) {
            ...
            return (
              ...
              ((ref3 = this.elseBodyNode()) != null ? ref3.isStatement(o) : void 0)
            );
          };
        ...
        isComplexOrAssignable = function (node) {
          return (
            node.isComplex() ||
            (typeof node.isAssignable === 'function' ? node.isAssignable() : void 0)
          );
        };
      ...
      (function () {
        ...
        exports.compile = compile = withPrettyErrors(function (code, options) {
          ...
          if (options.inlineMap) {
            ...
            sourceURL =
              '//# sourceURL=' + ((ref1 = options.filename) != null ? ref1 : 'coffeescript');
            js = js + '\n' + sourceMapDataURI + '\n' + sourceURL;
          }
