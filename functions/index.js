...
exports.initializeUserPermissions = functions.https.onCall(async (data, context) => {
  // Only allow main admin to trigger this
  if (!context.auth || context.auth.token.email !== 'viljarpartel@gmail.com') {
  ...
  try {
    ...
    throw new functions.https.HttpsError('internal', 'Error initializing permissions');
  }
});
