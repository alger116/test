...
<head>
    ...
    <script type="module">
        ...
        import { getAuth, onAuthStateChanged, signInWithEmailAndPassword, signOut, setPersistence, browserLocalPersistence } from "https://www.gstatic.com/firebasejs/10.4.0/firebase-auth.js";
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('formApp', () => {
                ...
                return {
                    ...
                    showActionToast(message, type = 'clear', duration = 6000, actionText = null, actionCallback = null) {
                        console.log('Showing action toast:', { message, type, duration, actionText });

                        // Force gradient styles for clear toasts
                        if (type === 'clear') {
                            document.documentElement.style.setProperty('--clear-color', 'linear-gradient(135deg, #6366F1 0%, #8B5CF6 100%)');
                        }
                    ...
                    resetForm() {
                        if (confirm('Kas oled kindel, et soovid kõik andmed kustutada? Seda tegevust ei saa tagasi võtta.')) {
                            ...
                            // First show a regular toast that always works
                            this.showToast('Vorm on tühjendatud ✅', 'success');

                            // Also try the action toast
                            this.showActionToast('Vorm on tühjendatud', 'clear', 5000, '', () => {
                    ...
                    async sendPdfToOutlook(pdfData, fileName) {
                        try {
                            ...
                            const subject = encodeURIComponent(`${this.form.name || 'Ostumenetluse kutse'}`);
                            ...
                            this.showToast('Viga e-kirja koostamisel: ' + error.message, 'error');
                        }
                    },
                    ...
                    async clearPdfHistory() {
                        ...
                        try {
                            if (window.currentUser) {
                                ...
                                this.userSettings.generatedPdfs = [];
                                this.showActionToast('PDF ajalugu kustutatud', 'clear', 5000, '', () => {
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex flex-wrap gap-5 mt-8">
                        ...
                        <button @click="resetForm" x-show="currentUser"
                            ...
                            <span class="relative">
                                <span
                                    class="inline-block group-hover:-translate-y-px transition-transform duration-300">Tühjenda</span>
                                <span
                                    class="block h-0.5 w-0 group-hover:w-full bg-white transition-all duration-300 mt-0.5"></span>
                            </span>
                        </button>

                        <!-- Test button for direct notifications -->
            ...
            <div x-transition:enter="transition ease-out duration-300"
                ...
                <div class="flex items-center space-x-2 ml-auto">
                    <button x-show="toast.actionText"
                        @click="toast.actionCallback(); toasts = toasts.filter(t => t.id !== toast.id)"
                        ...
                        <div
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-600 mb-4">Salvestage oma põhiteave, mida saab automaatselt täita
                                        vormi avamisel.</p>
                                    ...
                                    <div class="bg-indigo-50 rounded-xl p-4 border border-indigo-100">
                                        <div class="flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-600">Lülitage sisse "Automaatne täitmine"
                                                    lüliti Põhiandmete sektsioonis, et põhiandmed täidetaksid vormi
                                                    automaatselt.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-emerald-50 rounded-xl p-4 border border-emerald-100">
                                        <div class="flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-600">"Tühjenda" nupp kustutab kogu ajaloo
                                                    jäädavalt. Enne kustutamist veenduge, et olete salvestanud vajalikud
                                                    PDF-id.</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="bg-gray-50 px-4 py-3 border-b border-gray-200">
                                <div class="flex justify-between items-center">
                                    ...
                                    <button @click="clearPdfHistory()"
                                        ...
                                        <i
                                            class="fas fa-trash-alt mr-1 group-hover:rotate-12 transition-transform duration-300"></i>
